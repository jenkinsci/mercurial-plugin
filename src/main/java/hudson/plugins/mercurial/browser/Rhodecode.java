 ...
 * <a href="http://rhodecode.org/">RhodeCode</a> repository.
 */
public class RhodeCode extends HgBrowser {
    ...
    public URL getDiffLink(String path) throws MalformedURLException {
        ...
        // this actually points to the getChangeSetLink() page, and just adds an anchor
        //
        // Rhodecode also has a specific page for a single diff, but that requires parameters we don't have here.
        ...
        return new URL(getUrl(), "changeset/" + current.getNode() + "#C" + path.replace("/", "-"));
    }
