...
public class MercurialSCMTest extends MercurialTestCase {
    ...
    public void testPollingLimitedToModules() throws Exception {
        FreeStyleProject p = createFreeStyleProject();
        p.setScm(new MercurialSCM(hgInstallation, repo.getPath(), null, null, "dir1 dir2", null, null, false, false));
        hg(repo, "init");
    ...
    public void testPollingLimitedToModules2() throws Exception {
        FreeStyleProject p = createFreeStyleProject();
        p.setScm(new MercurialSCM(hgInstallation, repo.getPath(), null, null, "dir1", null, null, false, false));
        hg(repo, "init");
    ...
    public void testChangelogLimitedToModules() throws Exception {
        ...
        p.setScm(new MercurialSCM(hgInstallation, repo.getPath(), null, null, "dir1 extra", null, null, false, false));
    ...
    public void testParameterizedBuildsBranch() throws Exception {
        ...
        assertTrue(log, log.contains("--branch b"));
